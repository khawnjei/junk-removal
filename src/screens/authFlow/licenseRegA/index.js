      ...
      <ImageBackground
        ...
        <View style={styles.contentWrapper}>
          ...
          <View style={styles.imageContainer}>
            <Image source={appIcons.licenseIconA} style={styles.licenseImage} />
          </View>
        </View>
        <View style={styles.buttonContainer}>
          <AppButton
            title={'Next'}
            onPress={() => navigation.navigate(routes.licenseRegB)}
          />
        </View>
      </ImageBackground>
    </View>
